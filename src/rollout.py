...
./rollout.py
~/Documents/Masters/results/ray_results_A_1_500/
impala/IMPALA_memory_multi_task_0_2020-03-31_21-06-07uyoit95p/checkpoint_10/checkpoint-10
 --run IMPALA --env procgen:procgen-caveflyer-v0 --steps 10000
...
# register_env("multi_task", environments.multi_task)
# register_env("single_task", environments.single_task)
